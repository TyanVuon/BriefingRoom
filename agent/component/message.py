...
class Message(ComponentBase):
    ...
    async def _stream(self, rand_cnt:str):
        ...
        clean = sanitize_user_facing_llm_output(all_content)
        self.set_output("content", clean)
        self._convert_content(clean)
        await self._save_to_memory(clean)
    ...
    def _invoke(self, **kwargs):
        ...
        self.set_output("downloads", downloads)
        content = sanitize_user_facing_llm_output(content)
