...
class LLM(ComponentBase):
    ...
    async def _stream_output_async(self, prompt, msg):
        ...
        self.set_output("content", sanitize_user_facing_llm_output(answer))
    ...
    async def _invoke_async(self, **kwargs):
        ...
        def clean_formated_answer(ans: str) -> str:
            ans = sanitize_user_facing_llm_output(ans)
        ...
        for _ in range(self._param.max_retries + 1):
            ...
            if ans.find("**ERROR**") >= 0:
                ...
                error = ans
                continue
            self.set_output("content", sanitize_user_facing_llm_output(ans))
            break
