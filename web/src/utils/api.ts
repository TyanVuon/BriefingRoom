...
export default {
  ...
  privacyStatus: `${restAPIv1}/privacy/status`,
  webauthnRegisterOptions: `${restAPIv1}/privacy/webauthn/register/options`,
  webauthnRegisterVerify: `${restAPIv1}/privacy/webauthn/register/verify`,
  webauthnAuthenticateOptions: `${restAPIv1}/privacy/webauthn/authenticate/options`,
  webauthnAuthenticateVerify: `${restAPIv1}/privacy/webauthn/authenticate/verify`,
  privacyVaultSeal: `${restAPIv1}/privacy/vault/seal`,
  privacyVaultUnseal: `${restAPIv1}/privacy/vault/unseal`,
  privacyVaultStatus: `${restAPIv1}/privacy/vault/status`,
  privacyVaultSetup: `${restAPIv1}/privacy/vault/setup`,
  privacyVaultUnlock: `${restAPIv1}/privacy/vault/unlock`,
  privacyVaultLock: `${restAPIv1}/privacy/vault/lock`,
